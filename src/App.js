  ...
  return (
    <>
      ...
      <Main>
        ...
        <Box>
          {clickedID ? 
          <DetailsBox clickedID={clickedID} setError2={setError2} setIsLoading2={setIsLoading2} setIdDetails={setIdDetails}>
            {isLoading2 && <Loader/>}
            {error2 && !isLoading2 && <ErrorMessage message={error2}/>}
            {!isLoading2 && !error2 && <Details idDetails={idDetails} setClickedID={setClickedID} onAddWatched={handleAddWatched} setUserRating={setUserRating} userRating={userRating} watched={watched}></Details>}
          </DetailsBox> :
          <>
...
function DetailsBox ({clickedID, setError2, setIsLoading2, children, setIdDetails}) {
  useEffect(function(){ 
...
function Details ({idDetails, setClickedID, onAddWatched, setUserRating, userRating, watched}) {
    ...
    <div className="details">
      ...
      <section>
        <div className="rating">
          {listImdbIds.includes(idDetails.imdbID) ? watched.forEach(searchID) : null}
